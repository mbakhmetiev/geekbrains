...
public class CoinPack implements Poolable {
    ...
    private float angle;
    private float scale;
    private float coinPackProbo;
    private float timeToLive;
    private Circle hitArea;

    private final float BASE_SIZE = 114.0f;
    ...
    public CoinPack(GameController gc) {
        this.gc = gc;
        ...
        this.timeToLive = 100.0f;
    }

    public void activate(float x, float y, float vx, float vy, float scale, float coinPackProbo) {
        ...
        this.coinPackProbo = coinPackProbo;
    }
