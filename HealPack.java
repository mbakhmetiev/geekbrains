...
public class HealPack implements Poolable {
    ...
    private float angle;
    private float scale;
    private float healPackProbo;
    private float timeToLive;
    private Circle hitArea;

    private final float BASE_SIZE = 50.0f;
    ...
    public float getHealPackProbo() { return healPackProbo; }

    public HealPack(GameController gc) {
        this.gc = gc;
        this.position = new Vector2(0, 0);
        this.velocity = new Vector2(0, 0);
        this.hitArea = new Circle(0, 0, 0);
        this.active = false;
        this.texture = Assets.getInstance().getAtlas().findRegion("healpac");
        this.timeToLive = 100;
    }

    public void activate(float x, float y, float vx, float vy, float scale, float healPackProbo) {
        ...
        this.healPackProbo = healPackProbo;
    }
